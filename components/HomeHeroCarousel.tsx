...
export default function HomeHeroCarousel({
  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      ...
      <div
        className="relative w-full h-[320px] sm:h-[350px] rounded-[28px] overflow-hidden border-[1.5px] border-[var(--border)] bg-[#1A0F07] shadow-lg select-none transition-shadow hover:shadow-xl"
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none z-10 bg-gradient-to-t from-black/80 via-black/25 to-black/30" />
        ...
        <div className="absolute inset-x-0 bottom-0 z-20 p-3.5 sm:p-4 flex flex-col space-y-2.5">
          ...
          <div className="relative w-full">
            <div
              className={`relative flex items-center w-full h-[48px] sm:h-[50px] rounded-full bg-white dark:bg-[#1A1009] border-[1.5px] shadow-xl backdrop-blur-md transition-all ${
                isSearchFocused
                  ? "border-[var(--accent)] ring-2 ring-orange-400/30"
            ...
            >
              ...
              <input
                ...
                className="w-full h-full pl-11 pr-10 rounded-full bg-transparent text-[var(--text)] font-baloo text-[14px] placeholder:text-[var(--muted)] placeholder:font-medium focus:outline-none"
            ...
            {searchQuery.trim().length > 0 && isSearchFocused && (
              <div
                className="absolute top-full inset-x-0 mt-2 z-50 max-h-72 overflow-y-auto rounded-[20px] bg-[var(--surface)] border-[1.5px] border-[var(--border)] shadow-2xl p-2 space-y-1 animate-in fade-in zoom-in-95 duration-150"
                  ...
                  <>
                    {searchResults.map((m) => (
                      <Link
                        ...
                        className="flex items-center justify-between p-2.5 rounded-[14px] hover:bg-[var(--accent-bg)] active:scale-[0.99] transition-all"
                      >
